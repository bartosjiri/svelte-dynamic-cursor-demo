<script lang="ts">
	...
	import { cursorVariant } from './cursor.store';
...
<div class:cursor-container={true}>
	<div
		class:cursor={true}
		class="--variant-{$cursorVariant}"
